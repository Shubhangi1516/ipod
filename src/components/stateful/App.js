...
export default class App extends React.Component{
        ...
        this.state={
            ...
            menu:{            //menu is an object
                  options:[   //options is an array of objects. the objects have array of choices 
                     {
            ...
            songsList:{
                ...
                songIndex:0,
                name:["The Show","Pefect", "Counting on"],
                isPlaying:false,
            },
...
//------------------------------------------------------------------------------------
    //Function to choose the menu to display and handle the menu clicks
   ...
   //Functionality to hanlde the Down Press CSS effect on Midle Button
   ...
   //Functionality to hanlde the Up Press CSS effect on Midle Button
